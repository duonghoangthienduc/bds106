        ...
        s.on("show_variation", (function (t, e) {
            ...
            jQuery(document.body).on("updated_cart_totals", (function () {
                ...
                Flatsome.attach("lazy-load-images", t),
                    ...
                    jQuery.fn.flatsomeSwatchesLoop && jQuery(".ux-swatches-in-loop:not(.js-ux-swatches)", t).flatsomeSwatchesLoop()
            }
            )),
                            ...
                            jQuery.post(flatsomeVars.ajaxurl, e, (function (t) {
                                ...
                                setTimeout((function () {
                                    ...
                                    t.imagesLoaded((function () {
                                        ...
                                        jQuery.fn.flatsomeSwatches && jQuery(".variations_form", t).flatsomeSwatches(),
                                ...
                                i.on("show_variation", (function (t, e) {
                                    e.image.src ? (r.attr("src", e.image.src).attr("srcset", ""),
                                        a.attr("href", e.image_link),
                                        n(),
                                        c()) : e.image_src && (r.attr("src", e.image_src).attr("srcset", ""),
                                            a.attr("href", e.image_link),
                                            n(),
                                            c())
                                }
