...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=7.4.4' --}}
    src="{{asset('public/js/polyfill.min.js')}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/contact-form-7/includes/js/index.js?ver=5.4.2' --}}
    src="{{asset("public/js/index.js")}}"
    id='contact-form-7-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min.js?ver=2.70' --}}
    src="{{asset("public/js/jquery.blockUI.min.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/woocommerce/assets/js/frontend/add-to-cart.min.js?ver=5.5.2' --}}
    src="{{asset("public/js/add-to-cart.min.js")}}"
    id='wc-add-to-cart-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min.js?ver=2.1.4' --}}
    src="{{asset("public/js/js.cookie.min.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js?ver=5.5.2' --}}
    src="{{asset("public/js/woocommerce.min.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min.js?ver=5.5.2' --}}
    src="{{asset("public/js/cart-fragments.min.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/popups/public/assets/js/public.js?ver=1.9.3.8' --}}
    src="{{asset("public/js/public.js")}}"
    id='spu-public-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/themes/flatsome/inc/extensions/flatsome-live-search/flatsome-live-search.js?ver=3.14.2' --}}
    src="{{asset("public/js/flatsome-live-search.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/q2w3-fixed-widget/js/q2w3-fixed-widget.min.js?ver=5.3.0' --}}
    src="{{asset("public/js/q2w3-fixed-widget.min.js")}}"
    id='q2w3_fixed_widget-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/themes/aznet-vn/js/lightslider.min.js?ver=1.0.0' --}}
    src="{{asset("public/js/lightslider.min.js")}}"
    id='lightsliderjs-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/themes/aznet-vn/js/lightslider-init.js?ver=1.0.0' --}}
    src="{{asset("public/js/lightslider-init.js")}}"
    id='lightsliderinit-js'></script>
<script type='text/javascript' 
{{-- src='http://batdongsan106.webdaitin.biz/wp-includes/js/hoverIntent.min.js?ver=1.8.1' --}}
    src="{{asset('public/js/hoverIntent.min.js')}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/themes/flatsome/assets/js/flatsome.js?ver=942e5d46e3c18336921615174a7d6798' --}}
    src="{{asset('public/js/flatsome.js')}}"
    id='flatsome-js-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/themes/flatsome/assets/js/woocommerce.js?ver=707a90c89eab7247f6e9e1b12f4f381b' --}}
    src="{{asset("public/js/woocommerce.js")}}"
    id='flatsome-theme-woocommerce-js-js'></script>
<script type='text/javascript' 
{{-- src='http://batdongsan106.webdaitin.biz/wp-includes/js/wp-embed.min.js?ver=5.6.12' --}}
    src="{{asset('public/js/wp-embed.min.js')}}"
    id='wp-embed-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/themes/flatsome/assets/libs/packery.pkgd.min.js?ver=3.14.2' --}}
    src="{{asset('public/js/packery.pkgd.min.js')}}"
...
<script type='text/javascript' 
    {{-- src='http://batdongsan106.webdaitin.biz/wp-includes/js/zxcvbn-async.min.js?ver=1.0' --}}
    src="{{asset("public/js/zxcvbn-async.min.js")}}"
    id='zxcvbn-async-js'></script>
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-includes/js/dist/i18n.min.js?ver=9e36b5da09c96c657b0297fd6f7cb1fd' --}}
    src="{{asset("public/js/i18n.min.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-admin/js/password-strength-meter.min.js?ver=5.6.12' --}}
    src="{{asset("public/js/password-strength-meter.min.js")}}"
...
<script type='text/javascript'
    {{-- src='http://batdongsan106.webdaitin.biz/wp-content/plugins/woocommerce/assets/js/frontend/password-strength-meter.min.js?ver=5.5.2' --}}
    src="{{asset("public/js/password-strength-meter.min.js")}}"
